...
function viewBlog(id) {
	$.ajax({
        url: context + "admin/category/" + id,
        success: function(response) {
//            $('#viewUserHolder').html(response);
            $('#add_category1').replaceWith(response);
    ...
    $.ajax({
        ...
        success: function(data, textStatus, jqXHR) {
        	if(data.includes("<!DOCTYPE html>")) {
                ...
                $('#add_category1').replaceWith(data);
                applyPopUpJs();
                submitForm();
                hideInput();
        	}
...
//	    	$.ajax({
//	            url: "/admin/getEvernoteById/" + suggestion.data,
//	            success: function(response) {
//	            	
