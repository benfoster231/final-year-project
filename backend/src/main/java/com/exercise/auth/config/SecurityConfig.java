...
import com.exercise.auth.service.CustomOAuth2UserService;
import com.exercise.auth.config.OAuth2AuthenticationFailureHandler;
import com.exercise.auth.config.OAuth2AuthenticationSuccessHandler;
import com.exercise.auth.config.RestAuthenticationEntryPoint;
import com.exercise.auth.config.TokenAuthenticationFilter;
